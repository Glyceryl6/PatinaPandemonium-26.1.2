...
public class PatinaBlock extends Block implements PatinaOxidizable {
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hit) {
        ...
        InteractionResult result = this.source.defaultBlockState().useWithoutItem(level, player, hit);
    ...
    protected InteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
        VariantData data = this.data(level, pos);
        InteractionResult result = this.source.defaultBlockState().useItemOn(stack, level, player, hand, hit);
        this.restore(level, pos, data);
        return result;
    }
